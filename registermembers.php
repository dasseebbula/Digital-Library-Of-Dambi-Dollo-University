...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO users (fname, lname, idnum, entry_date, department, email, role) VALUES ('$fname','$lname','$idnum','$entry_date','$department','$email','$role')";
...
<body>
    ...
    <a href="circulationpage.php">Go to Mainpage</a>
</body>
</html>
